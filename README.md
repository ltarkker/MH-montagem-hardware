...
|-----------|--------|-------|
| Processador | AMD Ryzen 5 3600 "Zen 2" 6-Core 3.6GHz | 81,90 € |
| Motherboard | ASRock B550 Pro4 | 139,90 € |
| Memória RAM | G.SKILL Ripjaws V 16GB DDR4-3200MHz | 49,90 € |
| SSD | Kingston NV2 500GB NVMe PCIe Gen 4.0 | 45,90 € |
| Water Cooler | Arctic Liquid Freezer II 420 All-In-One | 119,90 € |
| Fonte | EVGA GQ 650W 80 Plus Gold Semi Modular | 90,90 € |
...
| Tema | Conteúdo |
|------|----------|
| Componentes de PC | CPU, motherboard, RAM, SSD, GPU, PSU, cooler, caixa |
| Compatibilidade | Sockets AM4, chipsets B550, DDR4, PCIe |
| Diagnóstico | Identificação e resolução de avarias de hardware |
| Orçamentação | Seleção de componentes por critérios de preço/desempenho |
| Montagem | Procedimentos de montagem e boas práticas |
